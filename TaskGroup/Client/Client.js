...
WeaveryClient.prototype = {
  ...
  gatherStatistics: function () {
    var self = this;
    self.statistics.clientId = self.clientImpl.clientId;
  },
  ...
  executeTaskPart: function (task, index, count, data, cb) {
    ...
    self.statistics.executionTimes.push({taskId: task.taskId, taskPart: index, startTime: startTime, endTime: endTime});
